...
const routes = [
  ...
  },
  {
    ...
    name: '用户信息',
    hidden: true,
    component: () => import('@/components/views/system/user/index')
  },
  {
    path: '/project',
    name: '项目信息',
    hidden: true,
    component: () => import('@/components/views/system/project/index')
  },
  {
    path: '/order',
    name: '订单信息',
    hidden: true,
    component: () => import('@/components/views/system/order/index')
  },
  {
    path: '/shop',
    name: '下单',
